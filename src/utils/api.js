...
export const GET_VENTAS = "ventas";
export const GET_COMISIONES = "comisiones";
...
// USER SIGNUP
export const user_signupApi = (name, email, mobile, type, address, firebase_id, logintype, profile, fcm_id, cargo, city,state,country, cedula) => {
...
export const getVentas = (asesor, offset, limit) => {
    return {
        url: `${GET_VENTAS}`,
        method: "GET",
        params: {
...
export const getComisiones = (asesor, offset, limit) => {
    return {
        url: `${GET_COMISIONES}`,
        method: "GET",
        params: {

        ...
        <div className="verticle_card">
            <div className="card ad_main_card">
                <div className="ad_card_img_div">
                    <Image loading="lazy" className="card-img" id="ad_card_img" src={`https://admin.rocaromana.co/images/publicity/${ele?.imagen}`} alt="no_img" width={200} height={330} onLoad={handleImageLoad} onError={placeholderImage} />
                </div>
            </div>
        </div>
    );

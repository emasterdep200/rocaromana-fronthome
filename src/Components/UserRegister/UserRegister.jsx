                                            ...
                                            <div className="row">
                                                ...
                                                <div className="col-sm-12 col-md-6">
                                                    <div className="user_fields">
                                                        ...
                                                        <input type="text" name="uname" placeholder="Enter Your Name" value={username} onChange={(e) => setUsername(e.target.value)} required    />
                                                    </div>
                                                </div>
                                                {signupData?.data?.data?.logintype === "1" ? (
                                                    ...
                                                    <div className="col-sm-12 col-md-6">
                                                        <div className="user_fields">
                                                            ...
                                                            <input type="text" name="mobile" placeholder="Enter Your Number" value={mobile} onChange={(e) => setMobile(e.target.value)} required/>
                                                        </div>
                                                    </div>

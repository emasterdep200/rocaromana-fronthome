...
const Nav = () => {
    ...
    const isSubscription = signupData?.data?.data?.subscription;
...
/*        if (signupData?.data?.data.name === "" || signupData?.data?.data.email === "" || signupData?.data?.data?.mobile === "") {
            Swal.fire({
    ...
    const handleShowDashboardAsesores = () => {
        router.push("/asesores/dashboard");
    };
                        ...
                        <div className="right-side">
                            <div className="collapse navbar-collapse" id="navbarSupportedContent">
                                <ul className="navbar-nav ml-auto">
                                            ...
                                            signupData?.data !== null ? (
                                                <Dropdown>
                                                    ...
                                                    <Dropdown.Menu id="language">
                                                        {signupData?.data?.data?.is_asesor != 1 && <Dropdown.Item onClick={handleShowDashboard}>
                                                            <span>
                                                                {translate("dashboard")}
                                                            </span>
                                                        </Dropdown.Item>}
                                                        
                                                        {signupData?.data?.data?.is_asesor == 1 && <Dropdown.Item onClick={handleShowDashboardAsesores}>
                                                            <span>
                                                                {translate("dashboard_asesor")}
                                                            </span>
                                                        </Dropdown.Item>}
                                    ...
                                    {(signupData?.data !== null ) && settingData && signupData?.data?.data?.is_asesor != 1 && (
                                        <li className="nav-item">
                    ...
                    <Offcanvas.Body>
                        <div className="mobile_nav">
                            <ul className="navbar-nav" id="mobile-ul">
                                ...
                                { signupData?.data !== null && settingData && (
                                    <li className="nav-item">

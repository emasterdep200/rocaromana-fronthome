            ...
            <div id="searchbox" className="container">
                ...
                <div id="searchcard">
                    <div id="searchbuttoon">
                        <FiSearch size={20} />
                        <input className="searchinput" placeholder={translate("Search your property")} name="propertySearch" value={searchInput} onChange={(e) => setSearchInput(e.target.value)} />
                    </div>
                        ...
                        <div className="second-grup">
                            <div className="budget-price-modal filter_label_title">
                                ...
                                <div className="budget-inputs">
                                    <input className="price-input" type="number" placeholder={translate("Min Price")} name="minPrice" value={formData.minPrice} onChange={handleInputChange} />
                                    <input className="price-input" type="number" placeholder={translate("Max Price")} name="maxPrice" value={formData.maxPrice} onChange={handleInputChange} />
                                </div>
                            </div>
                        </div>

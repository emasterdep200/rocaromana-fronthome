...
import { FiMail, FiMessageSquare, FiPhoneCall, FiThumbsUp, FiHash } from 'react-icons/fi'
        ...
        <>
            <div className="card" id="owner-deatils-card">
                ...
                <div className="card-body">
                    ...
                    <div className="owner-contact">
                        <div>
                            <FiHash id="call-o" size={60} />
                        </div>
                        <div className="deatilss">
                            <span className="o-d">Codigo Inmueble</span>
                            <span className="value">{getPropData && getPropData.code}</span>
                        </div>
                    </div>

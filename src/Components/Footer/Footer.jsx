                            ...
                            <div id="footer_logo_section">
                                ...
                                {webdata && webdata.company_tel1 &&
                                    <div className="footer_contact_us">
                                        ...
                                        <div className="footer_contactus_deatils">
                                            <span className="footer_span">{translate("Whatsapp")}</span>
                    ...
                    <div className="col-12 col-md-6 col-lg-3">
                        <div id="footer_download_section">
                            ...
                            <div className="download_app_desc">
                                {webdata?.playstore_id ? (<span>{translate("Getthelatest")} {webdata?.company_name} {translate("Selectyourdevice")}</span>) : (<span>Muy pronto podras descargar nuestra App en tiendas </span>)}
                            </div>

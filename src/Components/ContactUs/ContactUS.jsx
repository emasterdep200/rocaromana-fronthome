                                        ...
                                        <div className="row">
                                            <div className="col-sm-12 col-md-6">
                                                ...
                                                <div className="form-inputs">
                                                    ...
                                                    <input type="text" className="form-custom-input" name="firstName" value={formData.firstName} onChange={handleInputChange} />
                                                </div>
                                            </div>
                                            <div className="col-sm-12 col-md-6">
                                                {/* Last Name */}
                                                <div className="form-inputs">
                                                    ...
                                                    <input type="text" className="form-custom-input" name="lastName"  value={formData.lastName} onChange={handleInputChange} />
                                                </div>
                                            </div>
                                            <div className="col-sm-12 col-md-6">
                                                {/* Email */}
                                                <div className="form-inputs">
                                                    ...
                                                    <input type="text" className="form-custom-input" name="email"  value={formData.email} onChange={handleInputChange} />
                                                </div>
                                            </div>
                                            <div className="col-sm-12 col-md-6">
                                                {/* Subject */}
                                                <div className="form-inputs">
                                                    ...
                                                    <input type="text" className="form-custom-input" name="subject"  value={formData.subject} onChange={handleInputChange} />
                                                </div>
                                            </div>
                                            <div className="col-sm-12">
                                                ...
                                                <div className="form-inputs">
                                                    ...
                                                    <textarea rows={8} className="form-custom-input-textarea" name="message"  value={formData.message} onChange={handleInputChange} />
                                                </div>
                                            </div>
                                        </div>

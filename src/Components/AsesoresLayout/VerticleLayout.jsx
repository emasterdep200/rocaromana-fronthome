...
import { userSignUpData } from "@/store/reducer/authSlice.js"
...
export default function VerticleLayoutAsesor(props) {
    ...
    const hasSubscription = userData?.data?.data?.subscription === 1 ? true : false;
    ...
    const subscriptionCheck = () => {
        ...
        let hsub = userData?.data?.data?.subscription === 1 ? true : false;
        console.log(hsub, userData, requiresSubscription, (requiresSubscription && !hsub));

        if (requiresSubscription && !hsub) {
            Swal.fire({
                icon: "error",
                title: "Oops...",
        ...
        <Box sx={{ display: "flex" }}>
            ...
            <Drawer variant="permanent" open={open}>
                ...
                <List className="drawer_list">
                    <ListItem disablePadding sx={{ display: "block" }} className={isRouteActive('/asesores/dashboard') ? 'drawer_list_item_active' : 'drawer_list_item'}>
                        <Link href="/asesores/dashboard">
                            <ListItemButton
                                sx={{
                                    minHeight: 30,
                            ...
                            >
                                <ListItemIcon
                                    className={isRouteActive('/asesores/dashboard') ? 'drawer_list_icon_active' : 'drawer_list_icon'}
                                    sx={{
                                        minWidth: 0,
                                        mr: open ? 3 : "auto",
                    ...
                    <Link href="/asesores/ventas">
                        <ListItem disablePadding sx={{ display: "block" }} className={isRouteActive('/asesores/ventas') ? 'drawer_list_item_active' : 'drawer_list_item'}>
                            <ListItemButton
                                sx={{
                                    minHeight: 30,
                                    justifyContent: open ? "initial" : "center",
                            ...
                            >
                                <ListItemIcon
                                    className={isRouteActive('/asesores/ventas') ? 'drawer_list_icon_active' : 'drawer_list_icon'}
                                    sx={{
                                        minWidth: 0,
                                        mr: open ? 3 : "auto",
                                        justifyContent: "center",
                                ...
                                <ListItemText primary={"Mis Ventas"} sx={{ opacity: open ? 1 : 0 }} />
                            </ListItemButton>
                        </ListItem>
                    </Link>


                    <Link href="/asesores/comisiones">
                        <ListItem disablePadding sx={{ display: "block" }} className={isRouteActive('/asesores/comisiones') ? 'drawer_list_item_active' : 'drawer_list_item'}>
                            <ListItemButton
                                sx={{
                                    minHeight: 30,
                                    justifyContent: open ? "initial" : "center",
                            ...
                            >
                                <ListItemIcon
                                    className={isRouteActive('/asesores/comisiones') ? 'drawer_list_icon_active' : 'drawer_list_icon'}
                                    sx={{
                                        minWidth: 0,
                                        mr: open ? 3 : "auto",
                                        justifyContent: "center",
                                ...
                                <ListItemText primary={"Mis Comisiones"} sx={{ opacity: open ? 1 : 0 }} />
                            </ListItemButton>
                        </ListItem>
                    </Link>
